                ...
                <div class="page-title">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2 style="height: 25px;">Data Perankingan</h2>
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        foreach ($sql1->result_array() as $data) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url(); ?>Bendahara/Data_ranking/v_detailRanking/<?= $data['id_spk']; ?>"><button type="button" class="btn btn-round btn-primary" data-toggle="modal"
                                                                                                                                   data-target="#" ><i class="fa fa-file-text-o">    Detail Ranking</i>
                                                        </button></a>
                                                </td>
                                            </tr>
                                            <?php
